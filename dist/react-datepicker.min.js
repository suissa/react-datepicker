  ...
  "object" == typeof exports && "undefined" != typeof module
    ...
    : "function" == typeof define && define.amd
      ...
      : t(
          ...
          e.differenceInCalendarQuarters,
  ...
  function (
    ...
    function Me(e, t, r, n, a) {
      ...
      if (
        ...
        var c = (null !== (o = t.match(Se)) && void 0 !== o ? o : [])
          .map(function (e) {
            var t = e[0];
            if ("p" === t || "P" === t) {
          ...
          .join("");
        e.length > 0 &&
          (s = K.parse(e, c.slice(0, e.length), new Date(), {
            useAdditionalWeekYearTokens: !0,
            useAdditionalDayOfYearTokens: !0,
          })),
          Ce(s) || (s = new Date(e));
    ...
    function Ce(e, t) {
      return (
        H.isValid(e) && !N.isBefore(e, null != t ? t : new Date("1/1/1800"))
      );
    }
    function _e(e, t, r) {
      if ("en" === r)
    ...
    function xe(e, t, r) {
      var n = Be(t || Ke());
      return te.startOfWeek(e, { locale: n, weekStartsOn: r });
    }
    function Oe(e) {
    ...
    function Ie() {
      return J.startOfDay(be());
    }
    function Re(e) {
      return v.endOfDay(e);
    }
    function Le(e) {
      return g.endOfMonth(e);
    }
    function Fe(e, t) {
      return e && t ? A.isSameYear(e, t) : !e && !t;
    }
    function Ae(e, t) {
      return e && t ? L.isSameMonth(e, t) : !e && !t;
    }
    function He(e, t) {
      return e && t ? F.isSameQuarter(e, t) : !e && !t;
    }
    function We(e, t) {
      return e && t ? R.isSameDay(e, t) : !e && !t;
    }
    function Qe(e, t) {
      return e && t ? I.isEqual(e, t) : !e && !t;
    }
    function qe(e, t, r) {
      var n,
        a = J.startOfDay(t),
        o = v.endOfDay(r);
      try {
        n = W.isWithinInterval(e, { start: a, end: o });
      } catch (e) {
        n = !1;
      }
      return n;
    ...
    function Ve(e, t) {
      return _e($.setMonth(be(), e), "LLLL", t);
    }
    function je(e, t) {
      return _e($.setMonth(be(), e), "LLL", t);
    }
    function Ue(e, t) {
      var r = void 0 === t ? {} : t,
        n = r.minDate,
        ...
        c = r.filterDate;
      return (
        rt(e, { minDate: n, maxDate: a }) ||
        (o &&
          o.some(function (t) {
            return t instanceof Date ? We(e, t) : We(e, t.date);
          })) ||
        (s &&
          s.some(function (t) {
            var r = t.start,
              n = t.end;
            return W.isWithinInterval(e, { start: r, end: n });
          })) ||
        (i &&
          !i.some(function (t) {
            return We(e, t);
        ...
        : (n &&
            n.some(function (t) {
              ...
              return t instanceof Date
                ? We(e, t)
                : We(e, null !== (r = t.date) && void 0 !== r ? r : new Date());
            })) ||
            !1;
    }
    function ze(e, t) {
    ...
    function Je(e, t) {
      ...
      return (
        ...
        (null == o
          ? void 0
          : o.some(function (t) {
              return He(e, t instanceof Date ? t : t.date);
            })) ||
        (s &&
          !s.some(function (t) {
            return He(e, t);
    ...
    function et(e, t) {
      ...
      return (
        ...
        (null == o
          ? void 0
          : o.some(function (e) {
              return Fe(l, e instanceof Date ? e : e.date);
            })) ||
        (s &&
          !s.some(function (e) {
            return Fe(l, e);
    ...
    function rt(e, t) {
      ...
      return (
        null !==
          (r =
            (a && u.differenceInCalendarDays(e, a) < 0) ||
            (o && u.differenceInCalendarDays(e, o) > 0)) &&
        void 0 !== r &&
        r
      );
    }
    function nt(e, t) {
      return t.some(function (t) {
        return (
          b.getHours(t) === b.getHours(e) &&
          C.getMinutes(t) === C.getMinutes(e) &&
          P.getSeconds(t) === P.getSeconds(e)
        );
      });
    }
    function at(e, t) {
      var r = void 0 === t ? {} : t,
        ...
        a = r.includeTimes,
        o = r.filterTime;
      return (n && nt(e, n)) || (a && !nt(e, a)) || (o && !o(e)) || !1;
    }
    function ot(e, t) {
      var r = t.minTime,
        n = t.maxTime;
      ...
      var a = be();
      (a = j.setHours(a, b.getHours(e))),
        (a = U.setMinutes(a, C.getMinutes(e))),
        (a = X.setSeconds(a, P.getSeconds(e)));
      var o = be();
      (o = j.setHours(o, b.getHours(r))),
        (o = U.setMinutes(o, C.getMinutes(r))),
        (o = X.setSeconds(o, P.getSeconds(r)));
      var s,
        i = be();
      (i = j.setHours(i, b.getHours(n))),
        (i = U.setMinutes(i, C.getMinutes(n))),
        (i = X.setSeconds(i, P.getSeconds(n)));
      try {
        s = !W.isWithinInterval(a, { start: o, end: i });
      } catch (e) {
        s = !1;
      }
      return s;
    ...
    function st(e, t) {
      var r = void 0 === t ? {} : t,
        ...
        o = ae.subMonths(e, 1);
      return (
        (n && f.differenceInCalendarMonths(n, o) > 0) ||
        (a &&
          a.every(function (e) {
    ...
    function it(e, t) {
      var r = void 0 === t ? {} : t,
        ...
        o = i.addMonths(e, 1);
      return (
        (n && f.differenceInCalendarMonths(o, n) > 0) ||
        (a &&
          a.every(function (e) {
    ...
    function lt(e, t) {
      var r = void 0 === t ? {} : t,
        ...
        o = ie.subYears(e, 1);
      return (
        (n && m.differenceInCalendarYears(n, o) > 0) ||
        (a &&
          a.every(function (e) {
    ...
    function ct(e, t) {
      var r = void 0 === t ? {} : t,
        ...
        o = d.addYears(e, 1);
      return (
        (n && m.differenceInCalendarYears(o, n) > 0) ||
        (a &&
          a.every(function (e) {
    ...
    function ut(e, t) {
      ...
      for (var n = new Map(), a = 0, o = e.length; a < o; a++) {
        ...
        if (T.isDate(s)) {
          ...
          var l = null !== (r = Object.keys(s)[0]) && void 0 !== r ? r : "",
            c = s[l];
          if ("string" == typeof l && Array.isArray(c))
        ...
        e.forEach(function (e) {
          ...
          if (T.isDate(n)) {
            var o = _e(n, "MM.dd.yyyy"),
              s = r.get(o) || { className: "", holidayNames: [] };
            if (
              !("className" in s) ||
              s.className !== t ||
              ((i = s.holidayNames),
              ...
              (s.holidayNames = c ? ge(ge([], c, !0), [a], !1) : [a]),
                r.set(o, s);
            }
          }
        }),
    ...
    function ht(e, t, r, n, a) {
      for (var i = a.length, l = [], p = 0; p < i; p++) {
        var d = e,
          u = a[p];
        u &&
          ((d = o.addHours(d, b.getHours(u))),
          (d = s.addMinutes(d, C.getMinutes(u))),
          (d = c.addSeconds(d, P.getSeconds(u))));
        var f = s.addMinutes(e, (r + 1) * n);
        O.isAfter(d, t) && N.isBefore(d, f) && null != u && l.push(u);
      }
      return l;
    }
    function mt(e) {
    ...
    function Dt(e) {
      if (!T.isDate(e)) throw new Error("Invalid date");
      var t = new Date(e);
      return t.setHours(0, 0, 0, 0), t;
    }
    function yt(e, t) {
      if (!T.isDate(e) || !T.isDate(t))
        throw new Error("Invalid date received");
      var r = Dt(e),
        n = Dt(t);
      return N.isBefore(r, n);
    }
    function kt(e) {
      return e.key === De.Space;
    }
    var wt,
      St = (function (e) {
        function t(t) {
          ...
          return (
            (n.inputRef = ue.default.createRef()),
        ...
        function n() {
          ...
          return (
            ...
            (n.handleOnKeyDown = function (e) {
              var t, r;
              e.key === De.Space && (e.preventDefault(), (e.key = De.Enter)),
                null === (r = (t = n.props).handleOnKeyDown) ||
                  void 0 === r ||
                  r.call(t, e);
            }),
            (n.isSameDay = function (e) {
              return We(n.props.day, e);
            }),
            (n.isKeyboardSelected = function () {
              var e;
              if (n.props.disabledKeyboardNavigation) return !1;
              var t = n.props.selectsMultiple
                  ? null === (e = n.props.selectedDates) || void 0 === e
                    ? void 0
                    : e.some(function (e) {
                        return n.isSameDayOrWeek(e);
                      })
                  : n.isSameDayOrWeek(n.props.selected),
                r = n.props.preSelection && n.isDisabled(n.props.preSelection);
              return !t && n.isSameDayOrWeek(n.props.preSelection) && !r;
            }),
            (n.isDisabled = function (e) {
              return (
                void 0 === e && (e = n.props.day),
                Ue(e, {
            ...
            (n.isStartOfWeek = function () {
              return We(
                n.props.day,
                xe(n.props.day, n.props.locale, n.props.calendarStartDay),
              );
            }),
            (n.isSameWeek = function (e) {
              return (
                n.props.showWeekPicker &&
                We(e, xe(n.props.day, n.props.locale, n.props.calendarStartDay))
              );
            }),
            ...
            (n.isInSelectingRange = function () {
              var e,
                ...
                c = t.endDate,
                p =
                  null !== (e = n.props.selectingDate) && void 0 !== e
                    ? e
                    : n.props.preSelection;
              return (
                !(!(a || o || s) || !p || (!i && n.isDisabled())) &&
                (a && c && (N.isBefore(p, c) || Qe(p, c))
                  ? qe(r, p, c)
                  : ((o && l && (O.isAfter(p, l) || Qe(p, l))) ||
                      !(!s || !l || c || (!O.isAfter(p, l) && !Qe(p, l)))) &&
                    qe(r, l, p))
              );
            }),
            ...
            (n.isAfterMonth = function () {
              return (
                ...
                (n.props.month + 1) % 12 === _.getMonth(n.props.day)
              );
            }),
            (n.isBeforeMonth = function () {
              return (
                void 0 !== n.props.month &&
                (_.getMonth(n.props.day) + 1) % 12 === n.props.month
              );
            }),
            (n.isCurrentDay = function () {
              return n.isSameDay(be());
            }),
            ...
            (n.getClassNames = function (e) {
              var r,
                a = n.props.dayClassName ? n.props.dayClassName(e) : void 0;
              return t.clsx(
                "react-datepicker__day",
                a,
                "react-datepicker__day--" + _e(n.props.day, "ddd", r),
                {
            ...
            (n.getAriaLabel = function () {
              var e = n.props,
                ...
                i = n.isDisabled() || n.isExcluded() ? s : a;
            ...
            (n.getTitle = function () {
              var e = n.props,
                ...
                i = [];
              return (
                a.has(s) && i.push.apply(i, a.get(s).holidayNames),
                n.isExcluded() &&
                  i.push(
                    null == o
                      ? void 0
            ...
            (n.getTabIndex = function () {
              var e = n.props.selected,
                t = n.props.preSelection;
              return (!n.props.showWeekPicker ||
                (!n.props.showWeekNumber && n.isStartOfWeek())) &&
                (n.isKeyboardSelected() || (n.isSameDay(e) && We(t, e)))
                ? 0
                : -1;
            }),
          ...
          return (
            ...
            (t.isKeyboardSelected = function () {
              return (
                ...
                !We(t.props.date, t.props.selected) &&
                We(t.props.date, t.props.preSelection)
              );
            }),
            (t.getTabIndex = function () {
              return t.props.showWeekPicker &&
                ...
                (t.isKeyboardSelected() ||
                  (We(t.props.date, t.props.selected) &&
                    We(t.props.preSelection, t.props.selected)))
                ? 0
                : -1;
            }),
        ...
        return (
          ...
          (n.prototype.render = function () {
            var e = this.props,
              r = e.weekNumber,
              a = e.ariaLabelPrefix,
              o = void 0 === a ? n.defaultProps.ariaLabelPrefix : a,
              s = e.onClick,
              i = {
                "react-datepicker__week-number": !0,
                "react-datepicker__week-number--clickable": !!s,
                "react-datepicker__week-number--selected":
                  !!s && We(this.props.date, this.props.selected),
              };
            return ue.default.createElement(
              "div",
              {
        ...
        function r() {
          ...
          return (
            ...
            (t.renderDays = function () {
              ...
              if (t.props.showWeekNumber) {
                ...
                n.push(
                  ue.default.createElement(
                    Mt,
                    ve({ key: "W" }, r.defaultProps, t.props, {
                      weekNumber: o,
                      date: e,
                      onClick: s,
                    }),
            ...
            (t.isKeyboardSelected = function () {
              return (
                !t.props.disabledKeyboardNavigation &&
                !We(t.startOfWeek(), t.props.selected) &&
                We(t.startOfWeek(), t.props.preSelection)
              );
            }),
            t
          );
        ...
        return (
          ...
          (r.prototype.render = function () {
            var e = {
              ...
              "react-datepicker__week--selected": We(
                this.startOfWeek(),
                this.props.selected,
              ),
    ...
    var Ot = (function (e) {
        function n() {
          var n = (null !== e && e.apply(this, arguments)) || this;
          return (
            (n.MONTH_REFS = ge([], Array(12), !0).map(function () {
              return r.createRef();
            })),
            (n.QUARTER_REFS = ge([], Array(4), !0).map(function () {
              return r.createRef();
            })),
            (n.isDisabled = function (e) {
              return Ue(e, {
            ...
            (n.handleDayClick = function (e, t) {
              var r, a;
              null === (a = (r = n.props).onDayClick) ||
                void 0 === a ||
                a.call(r, e, t, n.props.orderInDisplay);
            }),
            (n.handleDayMouseEnter = function (e) {
              var t, r;
              null === (r = (t = n.props).onDayMouseEnter) ||
                void 0 === r ||
                r.call(t, e);
            }),
            (n.handleMouseLeave = function () {
              var e, t;
              null === (t = (e = n.props).onMouseLeave) ||
                void 0 === t ||
                t.call(e);
            }),
            ...
            (n.isRangeStartQuarter = function (e) {
              var t = n.props,
                ...
                a = t.startDate,
                o = t.endDate;
              return !(!a || !o) && He(z.setQuarter(r, e), a);
            }),
            ...
            (n.isRangeEndQuarter = function (e) {
              var t = n.props,
                ...
                a = t.startDate,
                o = t.endDate;
              return !(!a || !o) && He(z.setQuarter(r, e), o);
            }),
            (n.isInSelectingRangeMonth = function (e) {
              var t,
                ...
                c = r.endDate,
                p =
                  null !== (t = n.props.selectingDate) && void 0 !== t
                    ? t
                    : n.props.preSelection;
              return (
                !(!(o || s || i) || !p) &&
            ...
            (n.isCurrentMonth = function (e, t) {
              return x.getYear(e) === x.getYear(be()) && t === _.getMonth(be());
            }),
            (n.isCurrentQuarter = function (e, t) {
              return (
                x.getYear(e) === x.getYear(be()) && t === E.getQuarter(be())
              );
            }),
              ...
              for (
                var e = [],
                  ...
                  s = n.props.selected
                    ? (function (e) {
                        return n.props.showWeekPicker
                          ? xe(e, n.props.locale, n.props.calendarStartDay)
                          : n.props.selected;
                      })(n.props.selected)
                    : void 0,
            ...
            (n.onMonthClick = function (e, t) {
              var r = n.isMonthDisabledForLabelDate(t),
                a = r.isDisabled,
                o = r.labelDate;
              a || n.handleDayClick(Oe(o), e);
            }),
            (n.onMonthMouseEnter = function (e) {
              var t = n.isMonthDisabledForLabelDate(e),
                r = t.isDisabled,
                a = t.labelDate;
              r || n.handleDayMouseEnter(Oe(a));
            }),
            (n.handleMonthNavigation = function (e, t) {
              var r, a, o, s;
              null === (a = (r = n.props).setPreSelection) ||
                void 0 === a ||
                a.call(r, t),
                null ===
                  (s =
                    null === (o = n.MONTH_REFS[e]) || void 0 === o
                      ? void 0
                      : o.current) ||
                  void 0 === s ||
                  s.focus();
            ...
            (n.handleKeyboardNavigation = function (e, t, r) {
              var a,
                ...
                p = o.minDate,
                d = o.maxDate,
                u = o.showFourColumnMonthYearPicker,
                f = o.showTwoColumnMonthYearPicker;
              if (l) {
                var h = xt(u, f),
                  m = n.getVerticalOffset(h),
                  v = null === (a = Yt[h]) || void 0 === a ? void 0 : a.grid,
                  g = function (e, t, r) {
                    var n,
                      a,
                      o = t,
                    ...
                    return { newCalculatedDate: o, newCalculatedMonth: s };
                  };
                if (t !== De.Enter) {
                  var D = (function (e, t, r) {
                      for (
                        var a = e,
                          ...
                          s = 0,
                          i = g(a, t, r),
                          l = i.newCalculatedDate,
                          c = i.newCalculatedMonth;
                        !o;
            ...
            (n.onMonthKeyDown = function (e, t) {
              var r = n.props,
                a = r.disabledKeyboardNavigation,
                o = r.handleOnMonthKeyDown,
                s = e.key;
              s !== De.Tab && e.preventDefault(),
                a || n.handleKeyboardNavigation(e, s, t),
                o && o(e);
            }),
            (n.onQuarterClick = function (e, t) {
              var r = z.setQuarter(n.props.day, t);
              Je(r, n.props) || n.handleDayClick(Te(r), e);
            }),
            (n.onQuarterMouseEnter = function (e) {
              var t = z.setQuarter(n.props.day, e);
              Je(t, n.props) || n.handleDayMouseEnter(Te(t));
            }),
            (n.handleQuarterNavigation = function (e, t) {
              ...
              n.isDisabled(t) ||
                ...
                null ===
                  (s =
                    null === (o = n.QUARTER_REFS[e - 1]) || void 0 === o
                      ? void 0
                      : o.current) ||
                  void 0 === s ||
                  s.focus());
            ...
            (n.onQuarterKeyDown = function (e, t) {
              ...
              if (!n.props.disabledKeyboardNavigation)
                switch (o) {
                  case De.Enter:
                    n.onQuarterClick(e, t),
                      null === (a = (r = n.props).setPreSelection) ||
                        void 0 === a ||
                        a.call(r, n.props.selected);
                    break;
                  case De.ArrowRight:
                    if (!n.props.preSelection) break;
                    n.handleQuarterNavigation(
                      4 === t ? 1 : t + 1,
                      l.addQuarters(n.props.preSelection, 1),
                    );
                    break;
                  case De.ArrowLeft:
                    if (!n.props.preSelection) break;
                    n.handleQuarterNavigation(
                      1 === t ? 4 : t - 1,
                      oe.subQuarters(n.props.preSelection, 1),
                    );
                }
            }),
            ...
            (n.getTabIndex = function (e) {
              ...
              var t = _.getMonth(n.props.preSelection),
                r = n.isMonthDisabledForLabelDate(t).isDisabled;
              return e !== t || r || n.props.disabledKeyboardNavigation
                ? "-1"
                : "0";
            }),
            ...
            (n.getAriaLabel = function (e) {
              var t = n.props,
                ...
                a = void 0 === r ? "Choose" : r,
                o = t.disabledDayAriaLabelPrefix,
                s = void 0 === o ? "Not available" : o,
                i = t.day,
                l = t.locale,
                c = $.setMonth(i, e),
                p = n.isDisabled(c) || n.isExcluded(c) ? s : a;
            ...
            (n.getQuarterClassNames = function (e) {
              var r = n.props,
                ...
                m = (l || c || p || d || u) && Je(z.setQuarter(a, e), n.props);
              return t.clsx(
                "react-datepicker__quarter-text",
                "react-datepicker__quarter-".concat(e),
                {
                  "react-datepicker__quarter-text--disabled": m,
                  "react-datepicker__quarter-text--selected": i
                    ? n.isSelectedQuarter(a, e, i)
                    : void 0,
                  "react-datepicker__quarter-text--keyboard-selected":
                    !h && f && n.isSelectedQuarter(a, e, f) && !m,
                  "react-datepicker__quarter-text--in-selecting-range":
                    n.isInSelectingRangeQuarter(e),
                  "react-datepicker__quarter-text--in-range":
                    o && s ? tt(o, s, e, a) : void 0,
            ...
            (n.getQuarterContent = function (e) {
              var t,
                ...
                o = (function (e, t) {
                  return _e(z.setQuarter(be(), e), "QQQ", t);
                })(e, r.locale);
              return null !== (t = null == a ? void 0 : a(e, o)) && void 0 !== t
                ? t
                : o;
            }),
            (n.renderMonths = function () {
              var e,
                ...
                s = t.selected,
                i =
                  null === (e = Yt[xt(a, r)]) || void 0 === e ? void 0 : e.grid;
              return null == i
                ? void 0
                : i.map(function (e, t) {
                    return ue.default.createElement(
                        ...
                        return ue.default.createElement(
                          "div",
                          {
                            ...
                            onKeyDown: function (t) {
                              kt(t) && (t.preventDefault(), (t.key = De.Enter)),
                                n.onMonthKeyDown(t, e);
                            },
                            onMouseEnter: n.props.usePointerEvent
                              ? void 0
                              : function () {
                            ...
                            "aria-current": n.isCurrentMonth(o, e)
                              ? "date"
                              : void 0,
                            "aria-selected": s
                              ? n.isSelectedMonth(o, e, s)
                              : void 0,
                          },
                          n.getMonthContent(e),
                        );
                ...
                [1, 2, 3, 4].map(function (e, a) {
                  return ue.default.createElement(
                    "div",
                    {
                      ...
                      "aria-selected": r
                        ? n.isSelectedQuarter(t, e, r)
                        : void 0,
                      tabIndex: Number(n.getQuarterTabIndex(e)),
                      "aria-current": n.isCurrentQuarter(t, e)
                        ? "date"
                        : void 0,
                    },
          ...
          (n.prototype.render = function () {
            ...
            return ue.default.createElement(
              "div",
              {
                ...
                "aria-label": ""
                  .concat(s)
                  .concat(_e(n, "MMMM, yyyy", this.props.locale)),
                role: "listbox",
              },
              t
                ? this.renderMonths()
    ...
    function It(e, t) {
      for (var r = [], n = Oe(e), a = Oe(t); !O.isAfter(n, a); )
        r.push(be(n)), (n = i.addMonths(n, 1));
      return r;
    }
    var Rt = (function (e) {
        function r(t) {
          ...
          return (
            (r.renderOptions = function () {
              return r.state.monthYearsList.map(function (e) {
                var t = Y.getTime(e),
                  n = Fe(r.props.date, e) && Ae(r.props.date, e);
                return ue.default.createElement(
                  "div",
                  {
                    className: n
        ...
        function t() {
          ...
          return (
            ...
            (t.renderSelectOptions = function () {
              for (
                var e = Oe(t.props.minDate), r = Oe(t.props.maxDate), n = [];
                !O.isAfter(e, r);
                ...
                n.push(
                  ue.default.createElement(
                    "option",
                    { key: a, value: a },
                    _e(e, t.props.dateFormat, t.props.locale),
                  ),
                ),
                  (e = i.addMonths(e, 1));
              }
            ...
            (t.renderSelectMode = function () {
              return ue.default.createElement(
                "select",
                {
                  value: Y.getTime(Oe(t.props.date)),
            ...
            (t.onChange = function (e) {
              t.toggleDropdown();
              var r = be(e);
              (Fe(t.props.date, r) && Ae(t.props.date, r)) ||
                t.props.onChange(r);
            }),
            (t.toggleDropdown = function () {
              return t.setState({ dropdownVisible: !t.state.dropdownVisible });
        ...
        function t() {
          ...
          return (
            ...
            (r.handleClick = function (e) {
              var t, n;
              ((r.props.minTime || r.props.maxTime) && ot(e, r.props)) ||
            ...
            (r.renderTimes = function () {
              for (
                var e,
                  n = [],
                  a = "string" == typeof r.props.format ? r.props.format : "p",
                  o =
                    null !== (e = r.props.intervals) && void 0 !== e
                      ? e
                      : t.defaultProps.intervals,
                  i = r.props.selected || r.props.openToDate || be(),
                  l = Ye(i),
                  c =
                    r.props.injectTimes &&
            ...
            (r.renderTimeCaption = function () {
              return !1 === r.props.showTimeCaption
                ? ue.default.createElement(ue.default.Fragment, null)
                : ue.default.createElement(
                    "div",
                    {
                      className:
      ...
      At = (function (e) {
        function n(n) {
          ...
          return (
            (a.YEAR_REFS = ge([], Array(a.props.yearItemNumber), !0).map(
              function () {
                return r.createRef();
              },
            )),
            ...
            (a.isExcluded = function (e) {
              return $e(e, { excludeDates: a.props.excludeDates });
            }),
              ...
              if (void 0 !== l && void 0 !== c) {
                ...
                a.isDisabled(t) ||
                  ...
                  (null === (n = (r = a.props).setPreSelection) ||
                    ...
                    n.call(r, t),
                  e - p < 0
                    ? a.updateFocusOnPaginate(c - (p - e))
                    : e - p >= c
                      ? a.updateFocusOnPaginate(Math.abs(c - (e - p)))
                      : null ===
                          (s =
                            null === (o = a.YEAR_REFS[e - p]) || void 0 === o
                              ? void 0
                              : o.current) ||
                        void 0 === s ||
                        s.focus());
            ...
            (a.isCurrentYear = function (e) {
              return e === x.getYear(be());
            }),
            (a.isRangeStart = function (e) {
              return (
                a.props.startDate &&
                a.props.endDate &&
                Fe(G.setYear(be(), e), a.props.startDate)
              );
            }),
            (a.isRangeEnd = function (e) {
              return (
                a.props.startDate &&
                a.props.endDate &&
                Fe(G.setYear(be(), e), a.props.endDate)
              );
            }),
            (a.isInRange = function (e) {
              return Ze(e, a.props.startDate, a.props.endDate);
            }),
            (a.isInSelectingRange = function (e) {
              ...
              return (
                ...
                (r && i
                  ? Ze(e, a.selectingDate(), i)
                  : ((n && s) || !(!o || !s || i)) &&
                    Ze(e, s, a.selectingDate()))
              );
            }),
            (a.isSelectingRangeStart = function (e) {
              ...
              return Fe(
                s,
                o
                  ? null !== (t = a.selectingDate()) && void 0 !== t
                    ? t
                    : null
                  : null != n
                    ? n
            ...
            (a.isKeyboardSelected = function (e) {
              if (
                void 0 !== a.props.date &&
                null != a.props.selected &&
                null != a.props.preSelection
              ) {
                var t = a.props,
                  r = t.minDate,
                  n = t.maxDate,
                  ...
                  s = t.includeDates,
                  i = t.filterDate,
                  l = Ne(G.setYear(a.props.date, e)),
                  c = (r || n || o || s || i) && et(e, a.props);
                return (
                  !a.props.disabledKeyboardNavigation &&
                  !a.props.inline &&
                  !We(l, Ne(a.props.selected)) &&
                  We(l, Ne(a.props.preSelection)) &&
                  !c
                );
              }
            }),
            (a.onYearClick = function (e, t) {
              var r = a.props.date;
              void 0 !== r && a.handleYearClick(Ne(G.setYear(r, t)), e);
            }),
                ...
                switch (o) {
                  case De.Enter:
                    ...
                    a.onYearClick(e, t),
                      null === (n = (r = a.props).setPreSelection) ||
                        void 0 === n ||
                        n.call(r, a.props.selected);
                    break;
                  case De.ArrowRight:
                    if (null == a.props.preSelection) break;
                    a.handleYearNavigation(
                      t + 1,
                      d.addYears(a.props.preSelection, 1),
                    );
                    break;
                  case De.ArrowLeft:
                    if (null == a.props.preSelection) break;
                    a.handleYearNavigation(
                      t - 1,
                      ie.subYears(a.props.preSelection, 1),
                    );
                    break;
                  case De.ArrowUp:
                    if (
                    ...
                    a.handleYearNavigation(
                      h,
                      ie.subYears(a.props.preSelection, f),
                    );
                    break;
                  case De.ArrowDown:
                    if (
                    ...
                    a.handleYearNavigation(
                      h,
                      d.addYears(a.props.preSelection, f),
                    );
                }
              c && c(e);
            }),
            (a.getYearClassNames = function (e) {
              ...
              return t.clsx(
                ...
                n ? (null == d ? void 0 : d(G.setYear(n, e))) : void 0,
                {
                  "react-datepicker__year-text--selected": i
                    ? e === x.getYear(i)
                    : void 0,
                  "react-datepicker__year-text--disabled":
                    (o || s || l || c || p) && et(e, a.props),
            ...
            (a.getYearTabIndex = function (e) {
              if (
                ...
                return "-1";
              var t = x.getYear(a.props.preSelection),
                r = et(e, a.props);
              return e !== t || r ? "-1" : "0";
            }),
                  ...
                  t.push(
                    ue.default.createElement(
                      "div",
                      {
                        ...
                        onMouseEnter: d.props.usePointerEvent
                          ? void 0
                          : function (e) {
                              return o(e, r);
                            },
                        onPointerEnter: d.props.usePointerEvent
                          ? function (e) {
                              return o(e, r);
                            }
                          : void 0,
                        onMouseLeave: d.props.usePointerEvent
                          ? void 0
                          : function (e) {
                              return s(e, r);
                            },
                        onPointerLeave: d.props.usePointerEvent
                          ? function (e) {
                              return s(e, r);
                            }
                          : void 0,
    ...
    var Wt = (function (e) {
        function n(t) {
          ...
          (n.renderOptions = function () {
            var e = n.props.year,
              ...
              r = n.props.minDate ? x.getYear(n.props.minDate) : null,
              a = n.props.maxDate ? x.getYear(n.props.maxDate) : null;
            return (
              (a &&
          ...
          return (
            (n.state = {
              yearsList: Ht(n.props.year, s, n.props.minDate, n.props.maxDate),
            }),
      ...
      Qt = (function (e) {
        function t() {
          ...
          return (
            ...
            (t.renderSelectOptions = function () {
              for (
                var e = t.props.minDate ? x.getYear(t.props.minDate) : 1900,
                  r = t.props.maxDate ? x.getYear(t.props.maxDate) : 2100,
                  n = [],
                  a = e;
                a <= r;
                a++
                ...
                n.push(
                  ue.default.createElement("option", { key: a, value: a }, a),
                );
              return n;
            }),
            (t.onSelectChange = function (e) {
      ...
      Kt = (function (e) {
        function o(s) {
          ...
          return (
            (c.monthContainer = void 0),
            (c.handleClickOutside = function (e) {
              c.props.onClickOutside(e);
            }),
            (c.setClickOutsideRef = function () {
              return c.containerRef.current;
            }),
            (c.handleDropdownFocus = function (e) {
              ...
              (n = e.target),
                ...
                qt.some(function (e) {
                  ...
                  (null === (r = (t = c.props).onDropdownFocus) ||
                    void 0 === r ||
                    r.call(t, e));
            }),
            (c.getDateInView = function () {
              var e = c.props,
                ...
                i = n || r || t;
              return (
                i || (a && N.isBefore(s, a) ? a : o && O.isAfter(s, o) ? o : s)
              );
            }),
            ...
            (c.handleDayClick = function (e, t, r) {
              c.props.onSelect(e, t, r),
                c.props.setPreSelection && c.props.setPreSelection(e);
            }),
            (c.handleDayMouseEnter = function (e) {
              c.setState({ selectingDate: e }),
                c.props.onDayMouseEnter && c.props.onDayMouseEnter(e);
            }),
            (c.handleMonthMouseLeave = function () {
              c.setState({ selectingDate: void 0 }),
                c.props.onMonthMouseLeave && c.props.onMonthMouseLeave();
            }),
            (c.handleYearMouseEnter = function (e, t) {
              c.setState({ selectingDate: G.setYear(be(), t) }),
                c.props.onYearMouseEnter && c.props.onYearMouseEnter(e, t);
            }),
            (c.handleYearMouseLeave = function (e, t) {
              c.props.onYearMouseLeave && c.props.onYearMouseLeave(e, t);
            }),
            (c.handleYearChange = function (e) {
              var t, r, n, a;
              null === (r = (t = c.props).onYearChange) ||
                void 0 === r ||
                r.call(t, e),
                c.setState({ isRenderAriaLiveMessage: !0 }),
                c.props.adjustDateOnChange &&
                  (c.props.onSelect(e),
                  null === (a = (n = c.props).setOpen) ||
                    void 0 === a ||
                    a.call(n, !0)),
                c.props.setPreSelection && c.props.setPreSelection(e);
            }),
            (c.getEnabledPreSelectionDateForMonth = function (e) {
              if (!Ue(e, c.props)) return e;
              for (
                var t = Oe(e),
                  r = Le(e),
                  o = n.differenceInDays(r, t),
                  s = null,
                  i = 0;
                i <= o;
                i++
            ...
            (c.handleMonthChange = function (e) {
              var t,
                ...
                n,
                a =
                  null !== (t = c.getEnabledPreSelectionDateForMonth(e)) &&
                  void 0 !== t
                    ? t
                    : e;
              c.handleCustomMonthChange(a),
                c.props.adjustDateOnChange &&
                  (c.props.onSelect(a),
                  null === (n = (r = c.props).setOpen) ||
                    void 0 === n ||
                    n.call(r, !0)),
                c.props.setPreSelection && c.props.setPreSelection(a);
            }),
            (c.handleCustomMonthChange = function (e) {
              var t, r;
              null === (r = (t = c.props).onMonthChange) ||
                void 0 === r ||
                r.call(t, e),
                c.setState({ isRenderAriaLiveMessage: !0 });
            }),
            ...
            (c.changeYear = function (e) {
              c.setState(
                function (t) {
                  var r = t.date;
                  return { date: G.setYear(r, Number(e)) };
                },
                function () {
            ...
            (c.changeMonth = function (e) {
              c.setState(
                function (t) {
                  var r = t.date;
                  return { date: $.setMonth(r, Number(e)) };
                },
                function () {
                  return c.handleMonthChange(c.state.date);
                },
            ...
            (c.header = function (e) {
              void 0 === e && (e = c.state.date);
              var r = xe(e, c.props.locale, c.props.calendarStartDay),
                n = [];
              return (
                ...
                n.concat(
                  [0, 1, 2, 3, 4, 5, 6].map(function (e) {
                    var n = a.addDays(r, e),
                      o = c.formatWeekday(n, c.props.locale),
                      s = c.props.weekDayClassName
                        ? c.props.weekDayClassName(n)
                        : void 0;
                    return ue.default.createElement(
                      "div",
                      {
                        key: e,
                        "aria-label": _e(n, "EEEE", c.props.locale),
                        className: t.clsx("react-datepicker__day-name", s),
                      },
                      o,
                    );
                  }),
              ...
              c.setState(
                function (e) {
                  ...
                  return {
                    date: ie.subYears(
                      r,
                      c.props.showYearPicker
                        ? null !== (t = c.props.yearItemNumber) && void 0 !== t
                          ? t
                          : o.defaultProps.yearItemNumber
                        : 1,
                    ),
                  };
                },
            ...
            (c.clearSelectingDate = function () {
              c.setState({ selectingDate: void 0 });
            }),
            (c.renderPreviousButton = function () {
              var e, t, r;
              if (!c.props.renderCustomHeader) {
                var n,
                  a =
                    null !== (e = c.props.monthsShown) && void 0 !== e
                      ? e
                      : o.defaultProps.monthsShown,
                  s = c.props.showPreviousMonths ? a - 1 : 0,
                  i =
                    null !== (t = c.props.monthSelectedIn) && void 0 !== t
                      ? t
                      : s,
                  l = ae.subMonths(c.state.date, i);
                switch (!0) {
                  case c.props.showMonthYearPicker:
                    n = lt(c.state.date, c.props);
                    break;
                  case c.props.showYearPicker:
                    n = (function (e, t) {
                      var r = void 0 === t ? {} : t,
                        n = r.minDate,
                        a = r.yearItemNumber,
                        o = void 0 === a ? 12 : a,
                        s = vt(Ne(ie.subYears(e, o)), o).endPeriod,
                        i = n && x.getYear(n);
                      return (i && i > s) || !1;
                    })(c.state.date, c.props);
                    break;
                  case c.props.showQuarterYearPicker:
                    n = (function (e, t) {
                      var r = void 0 === t ? {} : t,
                        n = r.minDate,
                        a = r.includeDates,
                        o = re.startOfYear(e),
                        s = oe.subQuarters(o, 1);
                      return (
                        (n && h.differenceInCalendarQuarters(n, s) > 0) ||
                        (a &&
                          a.every(function (e) {
                ...
                if (
                  ((null !== (r = c.props.forceShowMonthNavigation) &&
                  void 0 !== r
                    ? r
                    : o.defaultProps.forceShowMonthNavigation) ||
                  ...
                  var u =
                    ...
                    D =
                      void 0 === g ? o.defaultProps.previousYearButtonLabel : g,
                    y = c.props,
                    k = y.previousMonthAriaLabel,
                    w =
                      void 0 === k
                        ? "string" == typeof v
                          ? v
                  ...
                  return ue.default.createElement(
                    "button",
                    {
                      ...
                      className: p.join(" "),
                      onClick: d,
                      onKeyDown: c.props.handleOnKeyDown,
                      "aria-label": u ? b : w,
                    },
                    ue.default.createElement(
                      "span",
            ...
            (c.renderNextButton = function () {
              var e;
              if (!c.props.renderCustomHeader) {
                var t;
                switch (!0) {
                  case c.props.showMonthYearPicker:
                    t = ct(c.state.date, c.props);
                    break;
                  case c.props.showYearPicker:
                    t = (function (e, t) {
                      var r = void 0 === t ? {} : t,
                        ...
                        a = r.yearItemNumber,
                        o = void 0 === a ? 12 : a,
                        s = vt(d.addYears(e, o), o).startPeriod,
                        i = n && x.getYear(n);
                      return (i && i < s) || !1;
                    })(c.state.date, c.props);
                    break;
                  case c.props.showQuarterYearPicker:
                    t = (function (e, t) {
                      var r = void 0 === t ? {} : t,
                        ...
                        s = l.addQuarters(o, 1);
                      return (
                        (n && h.differenceInCalendarQuarters(s, n) > 0) ||
                        (a &&
                          a.every(function (e) {
                    ...
                    break;
                  default:
                    t = it(c.state.date, c.props);
                }
                if (
                  ((null !== (e = c.props.forceShowMonthNavigation) &&
                  void 0 !== e
                    ? e
                    : o.defaultProps.forceShowMonthNavigation) ||
                    c.props.showDisabledMonthNavigation ||
                  ...
                  var a =
                    ...
                    p = void 0 === i ? o.defaultProps.nextMonthButtonLabel : i,
                    u = s.nextYearButtonLabel,
                    f = void 0 === u ? o.defaultProps.nextYearButtonLabel : u,
                    m = c.props,
                    v = m.nextMonthAriaLabel,
                    g =
                      void 0 === v
                        ? "string" == typeof p
                          ? p
            ...
            (c.renderCurrentMonth = function (e) {
              void 0 === e && (e = c.state.date);
              ...
              return (
                ...
                ue.default.createElement(
                  "h2",
                  { className: t.join(" ") },
                  _e(e, c.props.dateFormat, c.props.locale),
                )
              );
            }),
            (c.renderYearDropdown = function (e) {
              if ((void 0 === e && (e = !1), c.props.showYearDropdown && !e))
                return ue.default.createElement(
                  Qt,
                  ve({}, o.defaultProps, c.props, {
                    date: c.state.date,
                    onChange: c.changeYear,
                    year: x.getYear(c.state.date),
                  }),
                );
            }),
            (c.renderMonthDropdown = function (e) {
              if ((void 0 === e && (e = !1), c.props.showMonthDropdown && !e))
                return ue.default.createElement(
                  Tt,
                  ve({}, o.defaultProps, c.props, {
                    month: _.getMonth(c.state.date),
                    onChange: c.changeMonth,
                  }),
                );
            }),
            (c.renderMonthYearDropdown = function (e) {
              if (
                (void 0 === e && (e = !1), c.props.showMonthYearDropdown && !e)
              )
                return ue.default.createElement(
                  Lt,
                  ve({}, o.defaultProps, c.props, {
            ...
            (c.handleTodayButtonClick = function (e) {
              c.props.onSelect(Ie(), e),
                c.props.setPreSelection && c.props.setPreSelection(Ie());
            }),
              ...
              if (c.props.todayButton && !c.props.showTimeSelectOnly)
                return ue.default.createElement(
                  "div",
                  {
                    ...
                    onClick: c.handleTodayButtonClick,
                  },
                  c.props.todayButton,
                );
            }),
            (c.renderDefaultHeader = function (e) {
              ...
              return ue.default.createElement(
                ...
                ue.default.createElement(
                  ...
                  c.renderMonthDropdown(0 !== r),
                  c.renderMonthYearDropdown(0 !== r),
                  c.renderYearDropdown(0 !== r),
                ),
                ue.default.createElement(
                  "div",
            ...
            (c.renderCustomHeader = function (e) {
              var t,
                ...
                a = e.i;
              if (
                (c.props.showTimeSelect && !c.state.monthContainer) ||
                c.props.showTimeSelectOnly
              )
                return null;
              var o = st(c.state.date, c.props),
                s = it(c.state.date, c.props),
                i = lt(c.state.date, c.props),
                l = ct(c.state.date, c.props),
                p =
                  !c.props.showMonthYearPicker &&
                  !c.props.showQuarterYearPicker &&
                  !c.props.showYearPicker;
              return ue.default.createElement(
                ...
                null === (r = (t = c.props).renderCustomHeader) || void 0 === r
                  ? void 0
                  : r.call(
                      t,
                      ve(ve({}, c.state), {
                        ...
                        decreaseYear: c.decreaseYear,
                        increaseYear: c.increaseYear,
            ...
            (c.renderYearHeader = function (e) {
              var t = e.monthDate,
                r = c.props,
                n = r.showYearPicker,
                a = r.yearItemNumber,
                s = vt(t, void 0 === a ? o.defaultProps.yearItemNumber : a),
                i = s.startPeriod,
                l = s.endPeriod;
              return ue.default.createElement(
                "div",
                ...
                n ? "".concat(i, " - ").concat(l) : x.getYear(t),
              );
            }),
            (c.renderHeader = function (e) {
              var t = e.monthDate,
                r = e.i,
                n = { monthDate: t, i: void 0 === r ? 0 : r };
              switch (!0) {
                case void 0 !== c.props.renderCustomHeader:
                  return c.renderCustomHeader(n);
                case c.props.showMonthYearPicker ||
                  c.props.showQuarterYearPicker ||
                  c.props.showYearPicker:
                  return c.renderYearHeader(n);
                default:
                  return c.renderDefaultHeader(n);
              }
            }),
            (c.renderMonths = function () {
              var e, t;
              if (!c.props.showTimeSelectOnly && !c.props.showYearPicker) {
                for (
                  var r = [],
                    n =
                      null !== (e = c.props.monthsShown) && void 0 !== e
                        ? e
                        : o.defaultProps.monthsShown,
                    a = c.props.showPreviousMonths ? n - 1 : 0,
                    s =
                      c.props.showMonthYearPicker ||
                      c.props.showQuarterYearPicker
                        ? d.addYears(c.state.date, a)
                        : ae.subMonths(c.state.date, a),
                    l =
                      null !== (t = c.props.monthSelectedIn) && void 0 !== t
                        ? t
                        : a,
                  ...
                  r.push(
                    ue.default.createElement(
                      "div",
                      {
                        key: h,
                        ref: function (e) {
                          c.monthContainer = null != e ? e : void 0;
                        },
                        className: "react-datepicker__month-container",
                      },
                      c.renderHeader({ monthDate: f, i: p }),
                      ue.default.createElement(
                        Ot,
                        ve({}, o.defaultProps, c.props, {
                          ariaLabelPrefix: c.props.monthAriaLabelPrefix,
                          day: f,
                          onDayClick: c.handleDayClick,
                          handleOnKeyDown: c.props.handleOnDayKeyDown,
                          handleOnMonthKeyDown: c.props.handleOnKeyDown,
            ...
            (c.renderYears = function () {
              if (!c.props.showTimeSelectOnly)
                return c.props.showYearPicker
                  ? ue.default.createElement(
                      "div",
                      { className: "react-datepicker__year--container" },
                      c.renderHeader({ monthDate: c.state.date }),
                      ue.default.createElement(
                        At,
                        ve({}, o.defaultProps, c.props, {
                          selectingDate: c.state.selectingDate,
                          date: c.state.date,
                          onDayClick: c.handleDayClick,
                          clearSelectingDate: c.clearSelectingDate,
                          onYearMouseEnter: c.handleYearMouseEnter,
                          onYearMouseLeave: c.handleYearMouseLeave,
                        }),
                      ),
                    )
                  : void 0;
            ...
            (c.renderInputTimeSection = function () {
              var e = c.props.selected ? new Date(c.props.selected) : void 0,
                t =
                  e && Ce(e) && Boolean(c.props.selected)
                    ? ""
                        .concat(mt(e.getHours()), ":")
                        .concat(mt(e.getMinutes()))
                    : "";
              if (c.props.showTimeInput)
                return ue.default.createElement(
                  St,
                  ve({}, o.defaultProps, c.props, {
                    date: e,
            ...
            (c.renderAriaLiveRegion = function () {
              var e,
                t,
                r = vt(
                  c.state.date,
                  null !== (e = c.props.yearItemNumber) && void 0 !== e
                    ? e
                    : o.defaultProps.yearItemNumber,
                ),
                n = r.startPeriod,
                a = r.endPeriod;
              return (
                (t = c.props.showYearPicker
                  ? "".concat(n, " - ").concat(a)
                  : c.props.showMonthYearPicker || c.props.showQuarterYearPicker
                    ? x.getYear(c.state.date)
                    : ""
                        .concat(
                          Ve(_.getMonth(c.state.date), c.props.locale),
                          " ",
                        )
                        .concat(x.getYear(c.state.date))),
                ue.default.createElement(
                  "span",
                  {
                    role: "alert",
                  ...
                  c.state.isRenderAriaLiveMessage && t,
                )
              );
            }),
            (c.renderChildren = function () {
              if (c.props.children)
                return ue.default.createElement(
                  "div",
            ...
            (c.containerRef = r.createRef()),
            (c.state = {
              date: c.getDateInView(),
        ...
        return (
          ...
          (o.prototype.componentDidUpdate = function (e) {
            ...
            if (
              ...
              (We(this.props.preSelection, e.preSelection) &&
                this.props.monthSelectedIn === e.monthSelectedIn)
            )
              this.props.openToDate &&
                !We(this.props.openToDate, e.openToDate) &&
      ...
      Bt = function (e) {
        ...
        return "string" == typeof t
          ...
          : ue.default.isValidElement(t)
            ? ue.default.cloneElement(t, {
                className: ""
        ...
        return (
          ...
          (n.prototype.render = function () {
            var e = this.props,
              ...
              s = e.hidePopper,
              i = void 0 === s ? n.defaultProps.hidePopper : s,
              l = e.popperComponent,
              c = e.targetComponent,
              p = e.enableTabLoop,
              d = e.popperOnKeyDown,
            ...
            if (!i) {
              ...
              v = ue.default.createElement(
                ...
                ue.default.createElement(
                  ...
                  l,
                  m &&
                    ue.default.createElement(ce.FloatingArrow, {
                      ref: h.arrowRef,
                      context: h.context,
                      fill: "currentColor",
                      strokeWidth: 1,
            ...
            this.props.popperContainer &&
              (v = r.createElement(this.props.popperContainer, {}, v)),
              u &&
                !i &&
                (v = ue.default.createElement(
                  Vt,
            ...
            return ue.default.createElement(
              ...
              ue.default.createElement(
                "div",
                { ref: h.refs.setReference, className: D },
                c,
              ),
              v,
            );
      ...
      Xt =
        ...
        function (e) {
          var t,
            ...
            s = ve(ve({}, e), {
              hidePopper: n,
              popperProps: ve(ve({}, o), { arrowRef: a }),
            });
          return ue.default.createElement($t, ve({}, s));
        }),
        ...
        function n(o) {
          ...
          return (
            ...
            (s.modifyHolidays = function () {
              var e;
              return null === (e = s.props.holidays) || void 0 === e
                ? void 0
                : e.reduce(function (e, t) {
                    var r = new Date(t.date);
                    return Ce(r)
                      ? ge(ge([], e, !0), [ve(ve({}, t), { date: r })], !1)
                      : e;
                  }, []);
            }),
              ...
              return {
                ...
                preSelection:
                  null !==
                    ...
                    ? e
                    : a,
                highlightDates: ut(s.props.highlightDates),
                focused: !1,
            ...
            (s.resetHiddenStatus = function () {
              s.setState(ve(ve({}, s.state), { wasHidden: !1 }));
            }),
            (s.setHiddenStatus = function () {
              s.setState(ve(ve({}, s.state), { wasHidden: !0 }));
            }),
            ...
            (s.safeFocus = function () {
              setTimeout(function () {
                var e, t;
                null ===
                  (t =
                    null === (e = s.input) || void 0 === e
                      ? void 0
                      : e.focus) ||
                  void 0 === t ||
            ...
            (s.safeBlur = function () {
              setTimeout(function () {
                ...
                null ===
                  (t =
                    null === (e = s.input) || void 0 === e ? void 0 : e.blur) ||
                  void 0 === t ||
                  t.call(e);
              }, 0);
            }),
            ...
            (s.inputOk = function () {
              return T.isDate(s.state.preSelection);
            }),
            ...
            (s.handleFocus = function (e) {
              var t,
                ...
                n = s.state.wasHidden,
                a = !n || s.state.open;
              n && s.resetHiddenStatus(),
                !s.state.preventFocus &&
                  a &&
                  (null === (r = (t = s.props).onFocus) ||
                    void 0 === r ||
                    r.call(t, e),
                  s.props.preventOpenOnFocus ||
                    s.props.readOnly ||
                    s.setOpen(!0)),
                s.setState({ focused: !0 });
            }),
            (s.sendFocusBackToInput = function () {
              s.preventFocusTimeout && s.clearPreventFocusTimeout(),
            ...
            (s.handleCalendarClickOutside = function (e) {
              ...
              s.props.inline || s.setOpen(!1),
                null === (r = (t = s.props).onClickOutside) ||
                  void 0 === r ||
                  r.call(t, e),
                s.props.withPortal && e.preventDefault();
            }),
            (s.handleChange = function () {
              for (var e, t, r = [], a = 0; a < arguments.length; a++)
                r[a] = arguments[a];
              var o = r[0];
              if (
                !s.props.onChangeRaw ||
                (s.props.onChangeRaw.apply(s, r),
                o &&
                ...
                s.setState({
                  inputValue:
                    (null == o ? void 0 : o.target) instanceof HTMLInputElement
                      ? o.target.value
                      : null,
                ...
                var i = s.props,
                  l = i.dateFormat,
                  c = void 0 === l ? n.defaultProps.dateFormat : l,
                  p = i.strictParsing,
                  d = void 0 === p ? n.defaultProps.strictParsing : p,
                  u = i.selectsRange,
                  f = i.startDate,
                  h = i.endDate,
                  m =
                    (null == o ? void 0 : o.target) instanceof HTMLInputElement
                      ...
                      : "";
                if (u) {
                  var v = m.split("-", 2).map(function (e) {
                      return e.trim();
                    }),
                    g = v[0],
                    D = v[1],
                    y = Me(null != g ? g : "", c, s.props.locale, d),
                    k = Me(null != D ? D : "", c, s.props.locale, d),
                    w =
                      (null == f ? void 0 : f.getTime()) !==
                      (null == y ? void 0 : y.getTime()),
                    S =
                      (null == h ? void 0 : h.getTime()) !==
                      (null == k ? void 0 : k.getTime());
                  if (!w && !S) return;
                  if (y && Ue(y, s.props)) return;
                  if (k && Ue(k, s.props)) return;
                  null === (t = (e = s.props).onChange) ||
                    void 0 === t ||
                    t.call(e, [y, k], o);
                } else {
                  var M = Me(m, c, s.props.locale, d, s.props.minDate);
                  s.props.showTimeSelectOnly &&
                    s.props.selected &&
                    M &&
                    !We(M, s.props.selected) &&
                    (M = V.set(s.props.selected, {
                      hours: b.getHours(M),
                      minutes: C.getMinutes(M),
                      seconds: P.getSeconds(M),
                    })),
                    (!M && m) || s.setSelected(M, o, !0);
                }
              }
            }),
            (s.handleSelect = function (e, t, r) {
              if (
                (s.props.shouldCloseOnSelect &&
                  !s.props.showTimeSelect &&
                  s.sendFocusBackToInput(),
                s.props.onChangeRaw && s.props.onChangeRaw(t),
                s.setSelected(e, t, !1, r),
                s.props.showDateSelect &&
                ...
                var n = s.props,
                  a = n.startDate,
                  o = n.endDate;
                !a || o || (!s.props.swapRange && yt(e, a)) || s.setOpen(!1);
              }
            }),
            (s.setSelected = function (e, t, r, n) {
              var a,
                o,
                i = e;
              if (s.props.showYearPicker) {
                if (null !== i && et(x.getYear(i), s.props)) return;
              } else if (s.props.showMonthYearPicker) {
                if (null !== i && ze(i, s.props)) return;
              } else if (null !== i && Ue(i, s.props)) return;
              var l = s.props,
                c = l.onChange,
                p = l.selectsRange,
                d = l.startDate,
                ...
                m = l.minTime,
                v = l.swapRange;
              if (!Qe(s.props.selected, i) || s.props.allowSameDay || p || f)
                if (
                  (null !== i &&
                    (!s.props.selected ||
                      (r &&
                    ...
                    s.props.inline || s.setState({ preSelection: i }),
                  ...
                  if (null !== i)
                    if (null == h ? void 0 : h.length)
                      if (
                        ...
                        null == c || c(y, t);
                      } else null == c || c(ge(ge([], h, !0), [i], !1), t);
                    else null == c || c([i], t);
                } else null == c || c(i, t);
              r ||
                (null === (o = (a = s.props).onSelect) ||
                  void 0 === o ||
                  o.call(a, i, t),
                s.setState({ inputValue: null }));
            }),
            (s.setPreSelection = function (e) {
              var t = T.isDate(s.props.minDate),
                r = T.isDate(s.props.maxDate),
                n = !0;
              if (e) {
                var a = Ye(e);
                if (t && r) n = qe(e, s.props.minDate, s.props.maxDate);
                  ...
                  n = O.isAfter(e, o) || Qe(a, o);
                } else if (r) {
                  var i = Re(s.props.maxDate);
                  n = N.isBefore(e, i) || Qe(a, i);
                }
              }
            ...
            (s.handleTimeChange = function (e) {
              ...
              if (!s.props.selectsRange && !s.props.selectsMultiple) {
                var n = s.props.selected
                    ? s.props.selected
                    : s.getPreSelection(),
                  a = s.props.selected
                    ? e
                    : Pe(n, { hour: b.getHours(e), minute: C.getMinutes(e) });
                s.setState({ preSelection: a }),
                  null === (r = (t = s.props).onChange) ||
                    void 0 === r ||
                    r.call(t, a),
                  s.props.shouldCloseOnSelect &&
                    !s.props.showTimeInput &&
                    (s.sendFocusBackToInput(), s.setOpen(!1)),
            ...
            (s.onInputClick = function () {
              ...
              s.props.disabled || s.props.readOnly || s.setOpen(!0),
                null === (t = (e = s.props).onInputClick) ||
                  void 0 === t ||
                  t.call(e);
            }),
            (s.onInputKeyDown = function (e) {
              var t, r, n, a, o, i;
              null === (r = (t = s.props).onKeyDown) ||
                void 0 === r ||
                r.call(t, e);
              var l = e.key;
              if (
                ...
                if (s.state.open) {
                  if (l === De.ArrowDown || l === De.ArrowUp) {
                    e.preventDefault();
                    var c = s.props.showTimeSelectOnly
                        ? ".react-datepicker__time-list-item[tabindex='0']"
                        : s.props.showWeekPicker && s.props.showWeekNumbers
                          ? '.react-datepicker__week-number[tabindex="0"]'
                          : s.props.showFullMonthYearPicker ||
                              s.props.showMonthYearPicker
                            ? '.react-datepicker__month-text[tabindex="0"]'
                            : '.react-datepicker__day[tabindex="0"]',
                      p =
                        (null === (a = s.calendar) || void 0 === a
                          ? void 0
                          : a.containerRef.current) instanceof Element &&
                        s.calendar.containerRef.current.querySelector(c);
                    return void (
                      p instanceof HTMLElement && p.focus({ preventScroll: !0 })
                    );
                  }
                  var d = be(s.state.preSelection);
                  l === De.Enter
                    ? (e.preventDefault(),
                      s.inputOk() && s.state.lastPreSelectChange === tr
                        ? (s.handleSelect(d, e),
                          !s.props.shouldCloseOnSelect && s.setPreSelection(d))
                        : s.setOpen(!1))
                    : l === De.Escape
                      ? (e.preventDefault(),
                        s.sendFocusBackToInput(),
                        s.setOpen(!1))
                      : l === De.Tab && s.setOpen(!1),
                    s.inputOk() ||
                      null === (i = (o = s.props).onInputError) ||
                      void 0 === i ||
                      i.call(o, { code: 1, msg: Jt });
                }
              } else
                (l !== De.ArrowDown && l !== De.ArrowUp && l !== De.Enter) ||
                  null === (n = s.onInputClick) ||
                  void 0 === n ||
                  n.call(s);
            }),
            ...
            (s.onDayKeyDown = function (e) {
              ...
              if (
                ...
                var b = e.key,
                  M = e.shiftKey,
                  C = be(s.state.preSelection),
                  E = function (e, t) {
                    var r = t;
                    switch (e) {
                      case De.ArrowRight:
                        r = v ? p.addWeeks(t, 1) : a.addDays(t, 1);
                        break;
                      case De.ArrowLeft:
                        r = v ? se.subWeeks(t, 1) : ne.subDays(t, 1);
                        break;
                      case De.ArrowUp:
                        r = se.subWeeks(t, 1);
                        break;
                      case De.ArrowDown:
                        ...
                        break;
                      case De.PageUp:
                        r = M ? ie.subYears(t, 1) : ae.subMonths(t, 1);
                        break;
                      case De.PageDown:
                        r = M ? d.addYears(t, 1) : i.addMonths(t, 1);
                        break;
                      case De.Home:
                        r = xe(t, y, k);
                        break;
                ...
                if (b === De.Escape)
                  return (
                    ...
                    void (
                      s.inputOk() ||
                      null === (o = (n = s.props).onInputError) ||
                      void 0 === o ||
                      o.call(n, { code: 1, msg: Jt })
                    )
                  );
                var P = null;
                switch (b) {
                    ...
                    P = (function (e, t) {
                      for (var r = e, n = !1, a = 0, o = E(e, t); !n; ) {
                        ...
                        f &&
                          o < f &&
                          ((r = De.ArrowRight),
                          (o = Ue(f, s.props) ? E(r, o) : f)),
                          h &&
                            o > h &&
                            ((r = De.ArrowLeft),
                            (o = Ue(h, s.props) ? E(r, o) : h)),
                          Ue(o, s.props)
                            ? ((r !== De.PageUp && r !== De.Home) ||
                                (r = De.ArrowRight),
                              (r !== De.PageDown && r !== De.End) ||
                                (r = De.ArrowLeft),
                              (o = E(r, o)))
                            : (n = !0),
                          a++;
                ...
                if (P) {
                  if (
                    (e.preventDefault(),
                    s.setState({ lastPreSelectChange: tr }),
                    w && s.setSelected(P),
                    s.setPreSelection(P),
                    S)
                  ) {
                  ...
                  null === (c = (l = s.props).onInputError) ||
                    void 0 === c ||
                    c.call(l, { code: 1, msg: Jt });
              }
            }),
                ...
                ? ue.default.createElement(
                    ...
                    ve(
                      ...
                      s.state,
                      {
                        setOpen: s.setOpen,
                        dateFormat:
                          null !== (e = s.props.dateFormatCalendar) &&
                          void 0 !== e
                            ? e
                            : n.defaultProps.dateFormatCalendar,
                        onSelect: s.handleSelect,
                        onClickOutside: s.handleCalendarClickOutside,
                        holidays: ft(s.modifyHolidays()),
                        ...
                        dropdownMode:
                          null !== (t = s.props.dropdownMode) && void 0 !== t
                            ? t
                            : n.defaultProps.dropdownMode,
                      },
                    ),
                    s.props.children,
                  )
            ...
            (s.renderAriaLiveRegion = function () {
              var e,
                t = s.props,
                r = t.dateFormat,
                a = void 0 === r ? n.defaultProps.dateFormat : r,
                o = t.locale,
                i =
              ...
              return (
                (e = s.props.selectsRange
                  ? "Selected start date: "
                      .concat(
                        Ee(s.props.startDate, { dateFormat: i, locale: o }),
                        ". ",
                      )
                      .concat(
                        s.props.endDate
                          ? "End date: " +
                              Ee(s.props.endDate, { dateFormat: i, locale: o })
                          : "",
                      )
                  : s.props.showTimeSelectOnly
                    ? "Selected time: ".concat(
                        Ee(s.props.selected, { dateFormat: a, locale: o }),
                      )
            ...
            (s.renderDateInput = function () {
              var e,
                ...
                c = s.props.customInputRef || "ref",
                p = s.props,
                d = p.dateFormat,
                u = void 0 === d ? n.defaultProps.dateFormat : d,
                f = p.locale,
                h =
                      ...
                      : s.props.selectsRange
                        ...
                        : s.props.selectsMultiple
                          ? (function (e, t) {
                              ...
                              null !== (o = s.props.selectedDates) &&
                                void 0 !== o
                                ? o
                                : [],
                              { dateFormat: u, locale: f },
                            )
                          : Ee(s.props.selected, { dateFormat: u, locale: f });
              return r.cloneElement(
                ...
                (a.value = h),
                (a.onBlur = s.handleBlur),
                (a.onChange = s.handleChange),
                (a.onClick = s.onInputClick),
                (a.onFocus = s.handleFocus),
                (a.onKeyDown = s.onInputKeyDown),
                (a.id = s.props.id),
                (a.name = s.props.name),
                (a.form = s.props.form),
                (a.autoFocus = s.props.autoFocus),
                (a.placeholder = s.props.placeholderText),
                (a.disabled = s.props.disabled),
                (a.autoComplete = s.props.autoComplete),
                (a.className = t.clsx(l.props.className, i)),
                (a.title = s.props.title),
                (a.readOnly = s.props.readOnly),
                (a.required = s.props.required),
                (a.tabIndex = s.props.tabIndex),
                (a["aria-describedby"] = s.props.ariaDescribedBy),
                (a["aria-invalid"] = s.props.ariaInvalid),
                (a["aria-labelledby"] = s.props.ariaLabelledBy),
                (a["aria-required"] = s.props.ariaRequired),
                a),
              );
            }),
        ...
        return (
          ...
          (n.prototype.componentDidUpdate = function (e, t) {
            ...
            e.inline &&
              ...
              s && i
                ? _.getMonth(s) !== _.getMonth(i) ||
                  x.getYear(s) !== x.getYear(i)
                : s !== i) &&
              ...
              e.highlightDates !== this.props.highlightDates &&
                this.setState({
                  highlightDates: ut(this.props.highlightDates),
                }),
              t.focused ||
                    ...
                    ve(
                      {
                        ...
                        className: t.clsx(
                          o,
                          !o && a,
                          i && "react-datepicker-ignore-onclickoutside",
                        ),
                      },
              ...
              return (
                this.state.open &&
                  ...
                  (t = ue.default.createElement(
                    Vt,
                    ve({ portalId: this.props.portalId }, this.props),
                    t,
                  )),
                ue.default.createElement(
                  "div",
